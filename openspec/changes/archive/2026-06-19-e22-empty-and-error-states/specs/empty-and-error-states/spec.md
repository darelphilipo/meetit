...
Empty, loading, and error states in Meetit are rendered through three centralized helpers that produce consistent, accessible, neo-brutalist cards. Every async-wait point in the app uses one of these helpers — no inline `<div style="...">` ad-hoc states.
