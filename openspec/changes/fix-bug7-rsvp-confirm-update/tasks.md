...
- [ ] 1.3 Show "✏️ You're updating your RSVP" banner inside the overlay body **— still missing as of 2026-06-25**

## 2. New Endpoint

- [x] 2.1 `/api/my-rsvp` exists and returns `{ email, phone }` for the current user + event
- [-] 2.2 (Optional) Extend `/api/init` to include the user's RSVP'd events + contact info — **deferred, not needed for current UX**
...
- [ ] 3.2 Log `log("rsvp-updated eventId={id} user={u}")` **— still missing as of 2026-06-25**
