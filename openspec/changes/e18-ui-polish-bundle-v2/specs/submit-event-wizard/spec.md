# Spec — Submit Event Wizard

## Purpose

The submit-event wizard is a 4-card modal that collects title, category, organizer, date, time, location, Google Maps link, and description. This spec covers the wizard's layout, validation, and navigation.
