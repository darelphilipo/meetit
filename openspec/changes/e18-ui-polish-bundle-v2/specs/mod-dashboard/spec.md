...
The mod dashboard is a tabbed view showing pending event submissions, published events, and pitched ideas. Mods can approve/decline pending events, view details, see RSVPs, and dismiss pitches. This spec covers the dashboard's tabs, card layouts, and tab-state sync.
